...
<body>
   <table class="t01" width="100%" border="0">
	<h2 style="text-align: center;">주문목록</h2>
		<form action="payment" method="post">
		   	...
		   	<tr style="text-align: center" height="50px;" >
		   		<td><input type="text" name="order1" id="result1" value=" " readonly style="border:none; width:100%; height:auto;  text-align: center; font-size:20px; font-weight: bold;"></td>
		   		<td><input type="text" name="order1num" id="resultNum1" value=" " readonly style="border:none; width:100%; height:auto;  text-align: center; font-size:20px; font-weight: bold;"></td>
		   		<td><input type="text" name="order1price" id="resultPrice1" value=" " readonly style="border:none; width:100%; height:auto;  text-align: center; font-size:20px; font-weight: bold;"></td>
	...
	<table width="100%" border=10px; bordercolor="blue">
		 <tr>
			 <td>
				 <button type="submit" style="width:50%; height: 100px;" onclick="menuConfirm()">결제</button>
				 
				 <input type="button" value="취소" style="width:49%; height: 100px;" onclick="javascript:window.location='order'">
			</td>
		</tr>
    </table>
   </table>
